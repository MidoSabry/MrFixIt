...
public class CommentsFromAllClientsAdapter extends RecyclerView.Adapter<com.example.fixawy.Client.CommentsFromAllClients.CommentsFromAllClientsAdapter.CommentsItemViewHolder> {
    ...
    public CommentsFromAllClientsAdapter(Context context, String jobTitle) {
    ...
    @NonNull
    @Override
    public com.example.fixawy.Client.CommentsFromAllClients.CommentsFromAllClientsAdapter.CommentsItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.comment_item,null,false);
        com.example.fixawy.Client.CommentsFromAllClients.CommentsFromAllClientsAdapter.CommentsItemViewHolder viewHolder = new com.example.fixawy.Client.CommentsFromAllClients.CommentsFromAllClientsAdapter.CommentsItemViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.fixawy.Client.CommentsFromAllClients.CommentsFromAllClientsAdapter.CommentsItemViewHolder holder, int position) {
