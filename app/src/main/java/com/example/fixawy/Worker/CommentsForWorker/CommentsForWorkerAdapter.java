...
public class CommentsForWorkerAdapter extends RecyclerView.Adapter<com.example.fixawy.Worker.CommentsForWorker.CommentsForWorkerAdapter.CommentsItemViewHolder> {
    ...
    public CommentsForWorkerAdapter(Context context, String jobTitle) {
    ...
    @NonNull
    @Override
    public com.example.fixawy.Worker.CommentsForWorker.CommentsForWorkerAdapter.CommentsItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.comment_item,null,false);
        com.example.fixawy.Worker.CommentsForWorker.CommentsForWorkerAdapter.CommentsItemViewHolder viewHolder = new com.example.fixawy.Worker.CommentsForWorker.CommentsForWorkerAdapter.CommentsItemViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.fixawy.Worker.CommentsForWorker.CommentsForWorkerAdapter.CommentsItemViewHolder holder, int position) {
